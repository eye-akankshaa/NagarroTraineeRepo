...
import { Cart, Review } from '../Models/User';
...
export class ProductDetailsComponent implements OnInit {
  ...
  addReview(){
    ...
    this.reviewObj.registerId = this.authService.User.registerId;

    this.reviewObj.productId = this.chosenProduct.productId;

    // this.productService.addReviews(this.reviewObj).subscribe((res)=>{
    //     alert(res.message);
    // });
  }
